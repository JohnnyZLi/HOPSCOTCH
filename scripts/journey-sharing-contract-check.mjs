...
assert.equal(clampedV1.timeMs, 14400);
...
assert.equal(legacyParsedUrl.searchParams.get('t'), '8300');
...
assert.equal(composedGenerated.durationMs, 17000);
...
assert.equal(clampedV2.timeMs, 15800);
