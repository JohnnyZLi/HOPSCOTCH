...
assert.match(journey, /<SemanticScene state=\{state\} hostname=\{scenario\.hostname\} address=\{scenario\.destinationAddress\}\/>/, 'SemanticScene must remain driven only by simulated Journey state/hostname/address');
