...
model = r'''import type { BuilderGraph } from './model.ts';
import {
...
Path('src/builder/ipv6-routing-depth.ts').write_text(model, encoding='utf-8')
Path('src/BuilderIpv6RoutingDepthPanel.tsx').write_text(panel, encoding='utf-8')
Path('scripts/builder-ipv6-routing-depth-contract-check.mjs').write_text(contract, encoding='utf-8')
print('Wrote advanced OSPFv3/policy model, UI, and contract.')
