...
console.log('Builder OSPF contract passed: explicit Area 0 enablement, adjacencies, advertisements, deterministic SPF, automatic failure/cost reconvergence, AD precedence, forwarding, and schema-v5 persistence.');
