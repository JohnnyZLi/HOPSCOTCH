...
import type { BuilderDeviceOption, BuilderDeviceRef, BuilderDeviceWorkbenchInput, BuilderDeviceWorkbenchSnapshot, BuilderWorkbenchRow } from './builder/device-workbench.ts';
...
export function BuilderDeviceWorkbench({snapshot,options,onSelect,historicalSequence=null,diff=null,depthInput=null}:{snapshot:BuilderDeviceWorkbenchSnapshot;options:BuilderDeviceOption[];onSelect:(ref:BuilderDeviceRef)=>void;historicalSequence?:number|null;diff?:BuilderTimelineDeviceDiff|null;depthInput?:BuilderDeviceWorkbenchInput|null;}){
