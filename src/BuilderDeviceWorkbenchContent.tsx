...
export default function BuilderDeviceWorkbenchContent({snapshot,options,onSelect,historicalSequence=null,diff=null}:{snapshot:BuilderDeviceWorkbenchSnapshot;options:BuilderDeviceOption[];onSelect:(ref:BuilderDeviceRef)=>void;historicalSequence?:number|null;diff?:BuilderTimelineDeviceDiff|null;}){
