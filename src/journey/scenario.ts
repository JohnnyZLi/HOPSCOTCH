...
const impairmentProfiles = new Set<JourneyLegacyImpairmentProfile>(['clean', 'dns-failure', 'route-leak', 'server-failure', 'single-loss', 'latency-spike', 'route-failure', 'path-outage', 'congestion', 'partition']);
