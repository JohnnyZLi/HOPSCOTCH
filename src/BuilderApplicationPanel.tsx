...
import {
  ...
  type BuilderApplicationContext,
...
interface BuilderApplicationPanelProps {
...
export function BuilderApplicationPanel({ context, sourceNodeId, historical, onSessionState, onMessage }: BuilderApplicationPanelProps) {
